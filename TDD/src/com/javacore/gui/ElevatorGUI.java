...
public class ElevatorGUI extends JFrame implements ElevatorObserver {
    ...
    private void button1ActionPerformed(final ActionEvent e) throws IOException {
    ...
    private void initComponents() throws InterruptedException {
        ...
        contentPaneLayout.setVerticalGroup(contentPaneLayout.createParallelGroup()
                .addGroup(GroupLayout.Alignment.TRAILING, contentPaneLayout.createSequentialGroup()
                        .addContainerGap(26, Short.MAX_VALUE).addGroup(contentPaneLayout.createParallelGroup()
                                .addGroup(contentPaneLayout.createSequentialGroup().addGap(19, 19, 19)
