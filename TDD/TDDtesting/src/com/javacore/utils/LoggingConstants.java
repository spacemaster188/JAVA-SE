...
public enum LoggingConstants {
	...
	PROCESS_VALIDATION_OK("Validation of the correctness of ending transportation process - PASSED"),
	PROCESS_VALIDATION_FAIL("Validation of the correctness of ending transportation process - FAILED"),
	...
	private LoggingConstants(String c) {
	  this.c = c;
	}
